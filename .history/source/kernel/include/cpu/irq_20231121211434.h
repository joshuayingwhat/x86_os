...
void exception_handle_bound_range(void);
void exception_handle_invalid_opcode(void);
void exception_handle_device_unavailable(void);
void exception_handle_double_fault(void);
void exception_handle_invalid_tss(void);
void exception_handle_segment_not_present(void);
void exception_handle_stack_segment_fault(void);
void exception_handle_general_protection(void);
void exception_handle_page_fault(void);
void exception_handle_fpu_error(void);
void exception_handle_alignment_check(void);
void exception_handle_machine_check(void);
void exception_handle_smd_exception(void);
void exception_handle_virtual_exception(void);
